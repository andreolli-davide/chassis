"""Generate the deterministic persisted-format candidates for 1.0.0b1.

Run from the repository root with the 1.0.0b1 environment installed::
...
def main() -> None:
    ...
    if args.check:
        ...
        if stale:
            raise SystemExit("stale 1.0.0b1 format fixtures: " + ", ".join(stale))
